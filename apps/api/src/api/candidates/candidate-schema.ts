    ...
    body: z.object({
        ...
        experiences: z.object({
            ...
            professional: z
                ...
                .refine(
                    (profs) =>
                        _.uniqBy(profs, (prof) => `${prof.title}${prof.company}`).length ===
                        profs.length,
        ...
        achievements: z
            .array(
                z.object({
                    ...
                    issuer: z.string(),
                    workload: z.number().refine((p) => p > 0),
                    issueDate: DateSchema.nullable().default(null),
                    expirationDate: DateSchema.nullable().default(null),
