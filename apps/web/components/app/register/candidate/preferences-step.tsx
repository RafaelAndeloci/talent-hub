...
import { PreferencesStepSchema } from '@/types/app/register/candidate/form/schemas'
...
export function PreferencesStep({}: PreferencesStepProps) {
  ...
  const form = useForm<PreferencesStepSchema>({
    resolver: zodResolver(getStepSchema('preferences')),
  })
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Your preferred employment type</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
